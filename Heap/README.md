...
| ---------------------------------------------- | ---- | ------- | ------ | ---------------- |
| Heapify                                        | O(N) | O(logN) | O(N^2) | O(1)             |
| Insertion                                      | O(N) | O(logN) | O(N^2) | O(1)             |
| Deletion                                       | O(N) | O(logN) | O(N^2) | O(1)             |
| getMax (For max-heap) or getMin (For min-heap) | O(N) | O(1)    | O(N^2) | O(1)             |
| removeMin or removeMax                         | O(N) | O(1)    | O(N^2) | O(1)             |
